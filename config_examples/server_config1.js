class sdServerConfig
{
	...
	{
		//return [ 2 ]; // Return array of disallowed event IDs. Has higher priority over GetAllowedWorldEvents() and can be used to allow any new events that will be added to the game with updates
	...
	static onBeforeSnapshotLoad()
	{
		...
		{
			if ( /*sdShop.options[ i ]._class === 'sdCommandCentre' || */sdShop.options[ i ].upgrade_name === 'upgrade_invisibility' )
			{
