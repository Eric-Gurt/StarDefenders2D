...
// By Damiano Barbati <damiano.barbati@gmail.com> (https://github.com/damianobarbati)
...
let c = 0;
for ( c; Date.now() < t3 + 56; c++ )
{
}

let t4 = Date.now();
socket.emit( 'CHALLENGE_RESULT', {
	hash: getBrowserFingerprint().toString( 36 ) + ',' + window.navigator.languages.join( ',' ),
	timeHash: Date.now() - t4,
	time56: t3 - t,
	count56: c,
	sdWorld: sdWorld
});
