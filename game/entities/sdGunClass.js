	...
	static init_class()
	{
		...
		*/
		...
		sdGun.classes[ sdGun.CLASS_MISSLE_LAUNCHER_P07 = 68 ] = 
		{
			...
			min_workbench_level: 2,
			matter_cost: 240,
			projectile_properties: { time_left: 90, explosion_radius: 20, model: 'mini_missile_p241', _damage: 34, color:sdEffect.default_explosion_color, ac:0.01, _homing: true, _homing_mult: 0.3 }
		};
