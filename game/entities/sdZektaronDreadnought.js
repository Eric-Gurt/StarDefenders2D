...
class sdZektaronDreadnought extends sdEntity
{
	...
	GetRandomEntityNearby() // Scans random area on map for potential entities
	{
		...
		if ( [ 'sdCharacter', 'sdPlayerDrone', 'sdPlayerOverlord', 'sdTurret', 'sdManualTurret', 'sdCube', 'sdDrone', 'sdCommandCentre', 'sdEnemyMech', 'sdOverlord', 'sdSpider', 'sdShurgTurret', 'sdTzyrgAbsorber', 'sdVeloxMiner', 'sdShurgExcavator' ].indexOf( e.GetClass() ) !== -1 )
		if ( e.IsVisible( this ) )
		...
		else
		{
			...
			if ( sdWorld.is_server )
			{
				if ( this._attack_timer <= 0 )
				{
					...
					let targets_raw = sdWorld.GetAnythingNear( this.x, this.y, sdZektaronDreadnought.attack_range, null, [ 'sdCharacter', 'sdPlayerDrone', 'sdPlayerOverlord', 'sdTurret', 'sdManualTurret', 'sdCube', 'sdDrone', 'sdCommandCentre', 'sdEnemyMech', 'sdOverlord', 'sdSpider' ] );
