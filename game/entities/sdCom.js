...
class sdCom extends sdEntity
{
	static init_class()
	{
		...
		sdCom.com_visibility_ignored_classes = [ 'sdBG', 'sdWater', 'sdCom', 'sdDoor', 'sdTurret', 'sdCharacter', 'sdVirus', 'sdQuickie', 'sdOctopus', 'sdTeleport', 'sdCube', 'sdEnemyMech', 'sdBadDog', 'sdShark', 'sdDrone', 'sdBeamProjector', 'sdSandWorm', 'sdAmphid', 'sdAbomination', 'sdAsp', 'sdBiter', 'sdCouncilMachine', 'sdPlayerOverlord', 'sdVeloxMiner', 'sdShurgTurret', 'sdTzyrgAbsorber', 'sdSetrDestroyer', 'sdTutel', 'sdAbomination', 'sdMimic', 'sdShurgExcavator' ]; // Used for sdCube pathfinding now...
