...
class sdCom extends sdEntity
{
	static init_class()
	{
		...
		sdCom.com_visibility_ignored_classes = [ // Used for sdCube pathfinding now...
			'sdBG', 
			'sdWater', 
			'sdCom', 
			'sdDoor', 
		...
		sdCom.com_faction_attack_classes = [ // Classes which factions can attack (sdDrones, sdCharacters, etc...)
			'sdManualTurret', 
			'sdTurret', 
			'sdCharacter', 
			'sdDrone', 
		...
		sdCom.com_hostile_ground_mob_classes = [
			'sdBadDog',
			'sdVirus',
			'sdQuickie',
			'sdAsp',
