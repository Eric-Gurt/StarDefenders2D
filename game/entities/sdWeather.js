		...
		if ( r === sdWeather.EVENT_SDLOST_EXTRACTION )
		{
			...
			for ( let i = 0; i < sdWorld.sockets.length; i++ ) // Create the tasks
			{
				sdTask.MakeSureCharacterHasTask({ 
					...
					time_left: 30 * 60 * 5, // 5 minutes, more than enough for players to contribute to its completion, unless if it isn't
					for_all_players: true, // This task lets everyone contribute towards its completion
