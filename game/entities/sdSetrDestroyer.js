		...
		else
		{
			...
			if ( sdWorld.is_server )
			{
				...
				if ( this._move_dir_timer <= 0 )
				{
					...
					{
						if ( sdEntity.entities[ i ].GetClass() === 'sdEnemyMech' || sdEntity.entities[ i ].GetClass() === 'sdSpider' || sdEntity.entities[ i ].GetClass() === 'sdCube' || sdEntity.entities[ i ].GetClass() === 'sdDrone' || sdEntity.entities[ i ].GetClass() === 'sdCharacter' )
