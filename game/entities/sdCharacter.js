	...
	static init_class()
	{
		...
		*/
		...
		sdCharacter.img_helmets = [
			...
			sdWorld.CreateImageFromFile( 'helmet_array' ), // original by Silk1, remake by Ghost581
			...
			sdWorld.CreateImageFromFile( 'helmet_alpha' ), // original by Silk1, remake by Ghost581
			...
			sdWorld.CreateImageFromFile( 'helmet_harbringer' ), // by LordBored
		...
		sdCharacter.skins = [
			...
			sdWorld.CreateImageFromFile( 'skins/array' ), // original by Silk1, remake by Ghost581
			sdWorld.CreateImageFromFile( 'skins/nova' ), // by LazyRain
			sdWorld.CreateImageFromFile( 'skins/igris' ), // by Silk1
			sdWorld.CreateImageFromFile( 'skins/alpha' ), // original by Silk1, remake by Ghost581
			...
			sdWorld.CreateImageFromFile( 'skins/harbringer' ), // by LordBored
			...
			sdWorld.CreateImageFromFile( 'skins/wyern' ), // by LordBored
		];
