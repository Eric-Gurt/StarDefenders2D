	...
	static init_class()
	{
		...
		for ( var i = 0; i < 11; i++ )
		{
			...
			if ( i !== 8 )
			{
				...
				sdShop.options.push({ _class: 'sdDoor', width: 32, height: 32, filter: filter, model: sdDoor.MODEL_ARMORED_LVL2, _reinforced_level: 2, _category:'Doors', _min_build_tool_level: 3 });
			}
		}
