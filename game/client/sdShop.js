...
class sdShop
{
	static init_class()
	{
		...
		sdShop.options.push({ _class: 'sdFighterHover', _category:'Vehicles', _min_build_tool_level: 3 });
		sdShop.options.push({ _class: 'sdFighterHover', filter: 'hue-rotate(90deg) saturate(2)', _category:'Vehicles', _min_build_tool_level: 3 });
		sdShop.options.push({ _class: 'sdFighterHover', filter: 'hue-rotate(180deg) saturate(2)', _category:'Vehicles', _min_build_tool_level: 3 });
		sdShop.options.push({ _class: 'sdFighterHover', filter: 'hue-rotate(270deg) saturate(2)', _category:'Vehicles', _min_build_tool_level: 3 });
